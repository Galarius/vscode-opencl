...
intermediate products shall not occur. Edge case behavior is per the
...
[Math Functions](mathFunctions.html), [FP\_CONTRACT](FP_CONTRACT.html),
[FP\_FAST\_FMA](FP_CONTRACT.html)
